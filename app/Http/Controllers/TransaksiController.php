...
class TransaksiController extends Controller
{
    ...
    /**
     * Export laporan transaksi ke PDF (memakai filter yang sama).
     */
    public function laporanPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('transaksi.laporan-pdf', compact('transaksis', 'totalDenda'));
        return $pdf->download('laporan-transaksi-' . date('Y-m-d') . '.pdf');
    }

    /**
     * Terapkan filter ke query (dipakai bersama oleh laporan & laporanPdf).
     */
