                ...
                <form action="{{ route('kategori.update', $kategori->id) }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="3"
                                  class="mt-1 block w-full rounded-md shadow-sm text-sm border-gray-300">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="icon" id="icon" value="{{ old('icon', $kategori->icon) }}" placeholder="cth: code-slash"
                        ...
                        <div>
                            ...
                            <input type="text" name="warna" id="warna" value="{{ old('warna', $kategori->warna) }}" placeholder="cth: primary"
                                   class="mt-1 block w-full rounded-md shadow-sm text-sm border-gray-300">
                        </div>
                    </div>
