            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-3">
                ...
                <form action="{{ route('search') }}" method="GET" class="relative">
                    <input type="search" name="q" value="{{ request('q') }}"
                        ...
                        class="w-64 pl-9 pr-3 py-2 text-sm border-gray-300 rounded-md focus:border-indigo-500 focus:ring-indigo-500" />
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="px-4 pt-3 pb-2">
            <form action="{{ route('search') }}" method="GET">
                <input type="search" name="q" value="{{ request('q') }}"
                    placeholder="Cari buku, anggota, transaksi..."
                    class="w-full px-3 py-2 text-sm border-gray-300 rounded-md focus:border-indigo-500 focus:ring-indigo-500" />
            </form>
        </div>
